...
static const CGFloat kYSLScrollMenuViewHeight = 44;
...
- (void)viewDidLoad {
    ...
    _menuView = [[YSLScrollMenuView alloc]initWithFrame:CGRectMake(0, 0,screenWidth, kYSLScrollMenuViewHeight)];
    ...
    _contentScrollView.frame = CGRectMake(0,kYSLScrollMenuViewHeight, self.view.frame.size.width, self.view.frame.size.height - 146);
...
- (void)scrollMenuViewSelectedIndex:(NSInteger)index
{
    ...
    // item color
    [_menuView setItemTextColorForcurrentIndex :index];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    // item color
    [_menuView setItemTextColorForcurrentIndex:currentIndex];
