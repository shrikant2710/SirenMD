...
-(CGSize)sizewithFont:(UIFont *)font forMessage:(NSString *)text
{
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
	...
	if (title != nil) {
        ...
        CGSize expectedSizeTitle = [self sizewithFont:titleLabel.font forMessage:title];
	...
	if (message != nil) {
        ...
        CGRect expectedSizeMessage = [message boundingRectWithSize:maxSizeMessage
