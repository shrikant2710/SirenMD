...
- (void)viewDidLoad {
    ...
    [CommonFunctions setNavigationTitle:@"In App Notification" ForNavigationItem:self.navigationItem];
    [CommonFunctions setNavigationBarBackgroundWithImage:navigationBarBackgroundImage1 fromViewController:self];
    [CommonFunctions addLeftNavigationBarButton:self withImageName:@"backButton" WithNegativeSpacerValue:0];
}
